$("#imageUploadNoticeUnitForm").fileinput({//tender
    language: "tr",
    theme: "fas",
    uploadUrl: "/test/test",
    initialPreviewDownloadUrl: "/File/FileDownloadNoticeUnit",
...
function setImageNoticeUnit(prevArr, deleteObj,imageDivId = "imageUploadNoticeUnitForm") {
    if (prevArr == null)
        prevArr = new Array();
