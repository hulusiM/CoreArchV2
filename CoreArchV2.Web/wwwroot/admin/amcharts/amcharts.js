        ...
        parseDatesDraw: function () {
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                    ...
                    "MM" == A && (h = (p - l) / z, 1.5 <= (p - l) / z && (p = p - (h - 1) * z + d.getPeriodDuration("DD", 3), p = d.resetDateToMin(new Date(p),
                        A, 1).getTime(), C += z));
                    ...
                    m = l = p;
                    if (!isNaN(w))
                        for (h = 1; h < u; h += w) this.gridAlpha = this.minorGridAlpha, f = p + y * h, f = d.resetDateToMin(new Date(f), A, w, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0,
...
(function () {
    ...
    d.ValueAxis = d.Class({
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                if (this.autoGridCount || 0 !== this.gridCount)
                    if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime =
                        this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                    else
                            ...
                            if (t = x * g + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t)
                                if (isNaN(y) || Number(d.toFixed(t, y)) == t) {
                                    ...
                                    if (t == this.baseValue && "radar" != a.type) {
                                        ...
                                        D && (u = d.fitToBounds(2 * this.gridAlpha, 0, 1), isNaN(this.zeroGridAlpha) || (u = this.zeroGridAlpha),
                                            u = d.line(a.container, D, C, this.gridColor, u, 1, this.dashLength), u.translate(this.x, this.y), this.grid0 = u, a.axesSet.push(u), u.toBack(), d.setCN(a, u, this.bcn + "zero-grid-" + this.id), d.setCN(a, u, this.bcn + "zero-grid"))
                                    }
        ...
        getDateMinMax: function () {
            ...
            this.maximumDate && (this.maximumDate instanceof Date || (this.maximumDate = d.getDate(this.maximumDate, this.chart.dataDateFormat,
                "fff")), this.max = this.maximumDate.getTime())
        },
        formatValue: function (a, b, c) {
            var e = this.exponential,
                ...
                g = this.chart;
            if (f) return !0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1), this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"), c = Number(e[0]), e = Number(e[1]), c = d.roundTo(c, 14), 10 == c && (c = 1, e += 1), c = c + "e" + e, 0 === a && (c = "0"), 1 == a && (c = "1")) : (h && (e = String(a).split("."), e[1] ? (f.precision =
                ...
                "date" == this.type ? this.labelFunction(c, new Date(a), this).toString() : this.labelFunction(a, c, this).toString()), c
        },
        ...
        stackGraphs: function (a) {
                ...
                for (q =
                    ...
                    if (n = k[q], n.hidden) n.newStack && (h[p] = NaN, e[p] = NaN);
                        ...
                        if (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[p] = NaN, e[p] = NaN);
                            ...
                            "regular" == b && (r && (isNaN(c[p]) ? (c[p] = g, m.values.close =
            ...
            for (p = this.start; p <= this.end; p++)
                for (q = 0; q < k.length; q++) (n = k[q], n.hidden) ? n.newStack && (h[p] =
        ...
        coordinateToValue: function (a) {
            ...
            var b = this.axisWidth,
                ...
                f = this.min,
                g = this.minReal;
            return !0 === this.logarithmic ? Math.pow(10, (d ? !0 === e ? (b - a) / c : a / c : !0 === e ? a / c : (b -
                a) / c) + Math.log(g) * Math.LOG10E) : !0 === e ? d ? f - (a - b) / c : a / c + f : d ? a / c + f : f - (a - b) / c
        },
        ...
        handleSynchronization: function () {
            if (this.synchronizeWith) {
                ...
                e && (this.min = b * e, this.max = c * e, this.step = a * e, b = Math.abs(Math.log(Math.abs(Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)))) * Math.LOG10E), this.maxDecCount =
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            var ia = a.counter,
                ...
                da = a.offset,
                fa, Aa;
            g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), Q = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (J = g.lineColor), void 0 != g.color && (w = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha), isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness), !0 === g.inside && (I = !0, 0 < da && (da = 0)), isNaN(g.labelRotation) ||
            ...
            "V" == Oa && (n = 0);
            var ba;
            Q && "" !== c && (ba = a.autoWrap && 0 === n ? d.wrappedText(x, c, w, t, r, ga, k, Math.abs(h), 0) : d.text(x, c, w, t, r, ga, k), ga = ba.getBBox(), ha = ga.width, Pa = ga.height);
            if ("H" == Oa) {
                if (0 <= b && b <= za + 1 && (0 < B && 0 < z && b + l <= za + 1 && (fa = d.line(x, [b + l, b + l], [0, B], A, z, C), y.push(fa)), 0 < D && (Aa = d.line(x, [b, b + va, b + va], [X, X + ma, ma], J, D, C, H), y.push(Aa))), v = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ga = "start", v = "bottom" == ea ? I ? v + B : v - B : I ? v - B : v + B, G += 3, 0 < h && (G += h / 2 - 3, ga = "middle"), 0 < n && (ga = "middle")) : ga = "middle", 1 == ia && 0 < O && !g && !m && ca < za && (e = d.fitToBounds(b, 0, za), ca = d.fitToBounds(ca, 0, za), Y = e - ca, 0 < Y && (Da = d.rect(x, Y, a.height, S, O), Da.translate(e - Y + va, ma), y.push(Da))), "bottom" == ea ? (v += X + r / 2 + da, I ? (0 < n ?
                        ...
                        ha / 2 * Math.cos(T)), ba && (r = 0, I && (r = ha / 2 * Math.cos(T)), f + r > za + 2 || 0 > f)) ba.remove(), ba = null
            } else {
                0 <= b && b <= X + 1 && (0 < B && 0 < z && b + l <= X + 1 && (fa = d.line(x, [0, B + 1], [b + l, b + l], A, z, C), y.push(fa)), 0 < D && (Aa = d.line(x, [0, va, za + va], [b, b + ma, b + ma], J, D, C, H), y.push(Aa)));
                ga = "end";
                if (!0 === I && "left" == ea || !1 === I && "right" == ea) ga = "start";
                v = b - Pa / 2 + 2;
                1 == ia && 0 < O && !g && !m && (e = d.fitToBounds(b, 0, X), ca = d.fitToBounds(ca, 0, X), T = e - ca, Da = d.polygon(x, [0, a.width, a.width, 0], [0, 0, T, T], S, O), Da.translate(va, e - T + ma), y.push(Da));
                v += r / 2;
                "right" == ea ? (G +=
                    va + za + da, v += ma, I ? (f || (v -= r / 2 + 3), G = G - (B + 4) - Z) : (G += B + 4 + u, v -= 2, G += Z)) : I ? (G += B + 4 - da, f || (v -= r / 2 + 3), g && (G += va, v += ma), G += Z) : (G += -B - u - 4 - 2 - da, v -= 2, G -= Z);
                fa && ("right" == ea ? (na += va + da + za - 1, Y += ma, na = I ? na - u : na + u) : (na -= da, I || (na -= B + u)));
                f && (v += f);
                I = -3;
                "right" == ea && (I += ma);
                ba && (v > X + 1 || v < I) && (ba.remove(), ba = null)
            }
            ...
            ba && (ba.attr({
                ...
                v, NaN, !0), 0 !== n && ba.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ba), this.label = ba, d.setCN(p, ba, a.bcn + "label"), d.setCN(p, ba, q, !0), g && d.setCN(p, ba, "guide"));
            Aa && (d.setCN(p, Aa, a.bcn + "grid"), d.setCN(p, Aa, q, !0), g && d.setCN(p, Aa, "guide"));
            Da && (d.setCN(p, Da, a.bcn + "fill"), d.setCN(p, Da, q, !0));
            m ? Aa && d.setCN(p, Aa, a.bcn + "grid-minor") : (a.counter = 0 === ia ? 1 : 0, a.previousCoord = b);
...
(function () {
    ...
    d.AmChart = d.Class({
        ...
        initChart: function () {
            ...
            this.destroy();
            (a = this.container) ? (a.container.innerHTML = "", a.width = this.realWidth, a.height = this.realHeight, a.addDefs(this), this.chartDiv.appendChild(a.container)) : a = new d.AmDraw(this.chartDiv,
                this.realWidth, this.realHeight, this);
            this.container = a;
            this.extension = ".png";
        ...
        measure: function () {
            ...
            if (a) {
                ...
                f = a.style;
                a = f.width;
                f = f.height; -1 != a.indexOf("px") && (c = d.removePx(a)); -1 != f.indexOf("px") &&
                    (e = d.removePx(f));
                e = Math.round(e);
                c = Math.round(c);
        ...
        checkTransform: function () {
            if (this.autoTransform && window.getComputedStyle) {
                var a = window.getComputedStyle(this.div, null);
                if ((a = a.getPropertyValue("-webkit-transform") || a.getPropertyValue("-moz-transform") || a.getPropertyValue("-ms-transform") ||
                        a.getPropertyValue("-o-transform") || a.getPropertyValue("transform")) && "none" !== a) {
                    var b = a.split("(")[1].split(")")[0].split(","),
                        a = b[0],
                        b = b[1],
                        c = Math.round(180 / Math.PI * Math.atan2(b, a));
        ...
        updateWidth: function () {
            ...
            if (c) {
                ...
                if ("right" == c || "left" == c) {
                    ...
                    "left" == c ? (g.left = d + "px", e.left = "0px") : (g.left = "0px",
                        e.left = a + "px");
                    b > f && (e.top = (b - f) / 2 + "px")
                }
            }
        ...
        showBalloonReal: function (a, b, c, e, d) {
            ...
            f.enabled && (f.followCursor(!1),
                f.changeColor(b), !c || f.fixedPosition ? (f.setPosition(e, d), isNaN(e) || isNaN(d) ? f.followCursor(!0) : f.followCursor(!1)) : f.followCursor(!0), a && f.showBalloon(a))
        },
        ...
        handleMouseMove: function (a) {
            ...
            if (a) {
                ...
                isNaN(d) ? this.mouseY = c : (this.mouseY = Math.min(c, d), this.mouse2Y =
                    Math.max(c, d));
    ...
    d.AmGraph = d.Class({
            ...
            if (e) {
                ...
                switch (m) {
                    ...
                    case "inside":
                        ...
                        break;
                    case "middle":
                        "column" == this.type && (l = !0, q ? b -= (b - r) / 2 + x - 3 : c -= (c - w) /
                            2 + x - 3)
                }
        ...
        createSerialGraph: function () {
            ...
            for (L = Q; L <= ia; L++) {
                ...
                if (Ia) {
                    ...
                    "start" ==
                    this.pointPosition && (ja -= Y / 2 + Math.floor(Wa * Y / 2), ya = 0, Ga = Math.floor(Y) + Math.floor(Wa * Y));
                    "end" == this.pointPosition && (ja += Y / 2 + Math.floor(Wa * Y / 2), ya = Math.floor(Y) + Math.floor(Wa * Y), Ga = 0);
                    if (Nb) {
                        var Cb = this.columnWidth;
                        isNaN(Cb) || (ya *= Cb, Ga *= Cb)
                    }
                    I || (v.x = ja); -1E5 > ja && (ja = -1E5);
                    ja > n + 1E5 && (ja = n + 1E5);
                    t ? (E = F, N = M, M = F = ja, isNaN(ta) && !this.fillToGraph && (N = ma), pa = qa, ra = sa) : (N = E = ja, isNaN(ta) && !this.fillToGraph && (M = ma));
                    if (!Bb && W < ta || Bb && W < Aa) v.isNegative = !0, Qa && (Ma = Qa), Za && (Va = Za), void 0 != Ja && (Ha = Ja);
                    $a = !1;
                    isNaN(W) ||
                        (m ? W > Ta ? (Sa && ($a = !0), Sa = !1) : (Sa || ($a = !0), Sa = !0) : v.isNegative = W < Oa ? !0 : !1, Aa = W);
                    var Ob = !1;
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(W)) x || (this.drawLineGraph(y, u, U, V), y = [], u = [], U = [], V = []);
                                ...
                                if ($a || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 !=
                            ...
                            break;
                        case "smoothedLine":
                            if (isNaN(W)) x || (this.drawSmoothedGraph(y,
                                u, U, V), y = [], u = [], U = [], V = []);
                            else {
                                if (Math.abs(E - jb) >= lb || Math.abs(F - kb) >= lb) y.push(E), u.push(F), jb = E, kb = F;
                                wa = E;
                                ...
                                v.gap && (this.drawSmoothedGraph(y, u, U, V), y = [], u = [], U = [],
                                    V = [])
                            }
                            break;
                        case "step":
                            if (!isNaN(W)) {
                                t ? (isNaN(A) || (y.push(A), u.push(F - ya)), u.push(F - ya), y.push(E), u.push(F + Ga), y.push(E), !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B), V.push(M - ya)), U.push(N), V.push(M - ya), U.push(N), V.push(M + Ga))) : (isNaN(z) || (u.push(z), y.push(E - ya)), y.push(E - ya), u.push(F), y.push(E + Ga), u.push(F), !Ra || isNaN(M) || isNaN(N) || (isNaN(D) || (U.push(N - ya), V.push(D)), U.push(N - ya), V.push(M), U.push(N + Ga), V.push(M)));
                                A = E;
                                z = F;
                                B = N;
                                D = M;
                                ...
                                ka = E;
                                la = F;
                                if ($a || void 0 != v.lineColor || void 0 != v.fillColors ||
                                    !isNaN(v.dashLength)) {
                                    var cc = y[y.length - 2],
                                        dc = u[u.length - 2];
                                    y.pop();
                                    ...
                                    y = [cc];
                                    u = [dc];
                                    t ? (u.push(F + Ga), y.push(E)) : (y.push(E + Ga), u.push(F));
                                    U = [];
                                    V = [];
                                    this.lineColorSwitched = v.lineColor;
                                    this.fillColorsSwitched = v.fillColors;
                                    this.dashLengthSwitched = v.dashLength;
                                    m && (Sa ? (this.lineColorSwitched = za, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Qa))
                                }
                                if (Nb || v.gap) A = z = NaN, this.drawLineGraph(y, u, U, V), y = [], u = [], U = [], V = []
                            } else if (!x) {
                                if (1 >= this.periodSpan ||
                                    1 < this.periodSpan && E - A > ya + Ga) A = z = NaN;
                                this.drawLineGraph(y, u, U, V);
                                y = [];
                                u = [];
                                U = [];
                        ...
                        case "column":
                            Ba = Ha;
                            void 0 != v.lineColor && (Ba = v.lineColor);
                            if (!isNaN(W)) {
                                m || (v.isNegative = W < Oa ? !0 : !1);
                                v.isNegative && (Qa && (Ma = Qa), void 0 != Ja && (Ba = Ja));
                                var Pb = f.min,
                                    Qb = f.max,
                                    ob = ta;
                                isNaN(ob) && (ob = Oa);
                                if (!(W < Pb && ob < Pb || W > Qb && ob > Qb)) {
                                    var Ca;
                                    if (t) {
                                        "3d" == O ? (P = F - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + S * ea, R = N + H * ea, Ca = ea) : (P = Math.floor(F - (r / 2 - ea) * (k + T) + T / 2), R = N, Ca = 0);
                                        K = k;
                                        wa = E;
                                        Ea = P + k / 2;
                                        ka = E;
                                        la = P + k / 2;
                                        P + K > q + Ca * S && (K = q - P + Ca * S);
                                        P < Ca * S && (K += P, P = Ca * S);
                                        aa = E - N;
                                        var ec = R;
                                        ...
                                        K = d.roundTo(K, 2);
                                        aa = d.roundTo(aa, 2);
                                        P < q && 0 < K && (ua = new d.Cuboid(h, aa, K, H - a.d3x, S - a.d3y, Ma, Va, ca, Ba, X, ga, w, t, da, bb, mb, Z), v.columnWidth = Math.abs(aa), v.columnHeight = Math.abs(K))
                                    } else {
                                        "3d" == O ? (R = E - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + H * ea, P = M + S * ea,
                                            Ca = ea) : (R = E - (r / 2 - ea) * (k + T) + T / 2, P = M, Ca = 0);
                                        K = k;
                                        wa = R + k / 2;
                                        Ea = F;
                                        ka = R + k / 2;
                                        la = F;
                                        R + K > n + Ca * H && (K = n - R + Ca * H);
                                        R < Ca * H && (K += R - Ca * H, R = Ca * H);
                                        aa = F - M;
                                        v.labelIsNegative = 0 < aa ? !0 : !1;
                                        ...
                                        K = d.roundTo(K, 2);
                                        aa = d.roundTo(aa, 2);
                                        R < n + ea * H && 0 < K && (this.showOnAxis && (P -= S / 2), ua = new d.Cuboid(h, K, aa, H - a.d3x, S - a.d3y, Ma, Va, ca, Ba, this.lineAlpha,
                                            ga, w, t, da, bb, mb, Z), v.columnHeight = Math.abs(aa), v.columnWidth = Math.abs(K))
                                    }
                                }
                                if (ua) {
                                    xa = ua.set;
                                    ...
                                    if (!I) {
                                        ...
                                        "3d" == O && (t ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, wa += H * this.columnIndex, ka += H * this.columnIndex, v.y += H * this.columnIndex) :
                                            (J = (C - c) * (L + 1) + 1E3 * this.depthCount, Ea += S * this.columnIndex, la += S * this.columnIndex, v.y += S * this.columnIndex));
                            ...
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (P < q && 0 < K) {
                                        ...
                                        !isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Db, [F, F], Ba, X, ca), cb = d.line(h,
                                            Eb, [F, F], Ba, X, ca));
                                        aa = E - N;
                                        ua = new d.Cuboid(h, aa, K, H, S, Ma, Ya, ca, Ba, X, ga, w, t, da, bb, mb, Z)
                                    }
                                } else {
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    ...
                                    if (R < n && 0 < K) {
                                        Bb && W >= ta && (Va = 0);
                                        var ua = new d.Cuboid(h, K, aa, H, S, Ma, Va, ca, Ba, X, ga, w, t, da, bb, mb, Z),
                                            Fb, Gb;
                                        W > ta ? (Fb = [F,
                                            sa
                                        ], Gb = [M, qa]) : (Fb = [M, sa], Gb = [F, qa]);
                                        !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Fb, Ba, X, ca), cb = d.line(h, [E, E], Gb, Ba, X, ca), d.setCN(a, Xa, this.bcn + "line-high"), v.className && d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"), v.className && d.setCN(a, cb, v.className, !0))
                                    }
                                }
                                ua && (xa = ua.set, v.columnGraphics = xa, fa.push(xa), xa.translate(R, P - ca / 2), (v.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (v.x = t ? P + K / 2 : R + K / 2, this.animateColumns(ua, L, E, N, F,
                                    M), this.addListeners(xa, v), void 0 !== this.tabIndex && xa.setAttr("tabindex", this.tabIndex)))
                            }
                            break;
                        case "ohlc":
            ...
            if ("line" ==
                g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(y, u, U, V) : this.drawLineGraph(y, u, U, V), I || this.launchAnimation();
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                void 0 === x || h.useNegativeColorIfDown || (p = d.line(l,
                    a, b, x, r, p, y, !1, !0, f), d.setCN(k, p, h.bcn + "stroke"), d.setCN(k, p, h.bcn + "stroke-negative"), n.push(p));
                if (0 < g || 0 < A)
                    if (p = a.join(";").split(";"), r = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), r = b.concat(e)) : "radar" == q ? (r.push(0), p.push(0)) : h.rotate ? (r.push(r[r.length - 1]), p.push(z), r.push(r[0]), p.push(z), r.push(r[0]), p.push(p[0])) : (p.push(p[p.length - 1]), r.push(z), p.push(p[0]), r.push(z), p.push(a[0]), r.push(r[0])) : "xy" == q && (b = h.fillToAxis) && (d.isString(b) &&
                        ...
                        "fill"), d.setCN(k, f, h.bcn + "fill-negative"), f.pattern(h.pattern, NaN, k.path), n.push(f), n.click(function (a) {
                            h.handleGraphEvent(a, "clickGraph")
                        }).mouseover(function (a) {
                            h.handleGraphEvent(a, "rollOverGraph")
                        }).mouseout(function (a) {
        ...
        drawSmoothedGraph: function (a, b, c, e) {
            if (1 < a.length) {
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + y + "," + b[b.length - 1], n += " L" + y + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + y, n += " L" + a[0] + "," + y), n += " L" + a[0] + "," + b[0]), c =
                    new d.Bezier(g, m, p, NaN, 0, 0, t, q, h, n, u), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), w || void 0 !== r) && (x || (x = q), w || (w = r), a = new d.Bezier(g, a, b, NaN, 0, 0, w, x, h, n, u), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
                this.applyMask(l, k)
            }
        },
        ...
        createBullet: function (a, b, c) {
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                l && (p && p.remove(), "function" == typeof l ? (l = new l, l.chart = e, a.bulletConfig && (l.availableSpace = c, l.graph = this, l.graphDataItem = a, l.bulletY = c, a.bulletConfig.minCoord = this.minCoord - c,
                    l.bulletConfig = a.bulletConfig), l.write(h), p && l.showBullet && l.set.push(p), a.customBulletGraphics = l.cset, p = l.set) : (p = h.set(), l = h.image(l, 0, 0, g, g), p.push(l), this.centerCustomBullets && l.translate(-g / 2, -g / 2)));
                if (p) {
        ...
        hideBalloon: function () {
            var a = this,
                b = a.chart;
            b.chartCursor ?
                b.chartCursor.valueBalloonsEnabled || b.hideBalloon() : b.hideBalloon();
            clearTimeout(a.hoverInt);
            a.hoverInt = setTimeout(function () {
                a.hideBalloonReal.call(a)
            }, b.hideBalloonTime)
    ...
    d.ChartCursor = d.Class({
        ...
        fixWidth: function (a) {
            if (this.fullWidth && this.prevLineWidth != a) {
                ...
                b.translate(c, 0);
                c = d.rect(this.container, a, this.height, this.cursorColor,
                    this.cursorAlpha, 0);
        ...
        hideCursor: function (a) {
            ...
            this.chart.wasTouched && this.leaveAfterTouch ||
                this.isHidden || this.leaveCursor || (this.hideCursorReal(), a ? this.chart.handleCursorHide() : this.fire({
                    target: this,
                    chart: this.chart,
                    type: "onHideCursor"
        ...
        updateSelection: function () {
            if (!this.pan &&
                ...
                isNaN(this.mouse2X) && 0 < Math.abs(h) && 0 < Math.abs(f) && (a = this.chart, b = d.rect(this.container, h, f, this.cursorColor, this.selectionAlpha), d.setCN(a, b, "cursor-selection"), b.width = h, b.height =
                    f, b.translate(c, e), this.set.push(b), this.selection = b);
                this.updateFullLine()
            }
        },
        ...
        handleMouseDown: function () {
            this.update();
            if (this.mouseIsOver())
                if (this.mouseIsDown = !0, this.mouseX0 = this.mouseX,
                    this.mouseY0 = this.mouseY, this.mouse2X0 = this.mouse2X, this.mouse2Y0 = this.mouse2Y, this.drawing) this.drawStartY = this.mouseY, this.drawStartX = this.mouseX, this.drawingNow = !0;
        ...
        handleReleaseOutside: function () {
            ...
            this.zooming && (this.zooming = !1, this.selectWithoutZooming ? this.dispatchZoomEvent("selected") :
                (this.hZoomEnabled || this.vZoomEnabled) && this.dispatchZoomEvent("zoomed"), this.rolledOver && this.dispatchMovedEvent(this.mouseX, this.mouseY));
            ...
            if (!this.pan) {
                ...
                if (b && 3 < Math.abs(b.width) && 3 < Math.abs(b.height)) {
                    var c = Math.min(this.index, this.index0),
                        ...
                        k = g.chartData,
                        l = g.categoryAxis;
                    l && l.parseDates && !l.equalSpacing && (d = k[c] ? k[c].time : Math.min(this.timestamp0,
                        this.timestamp), f = k[e] ? g.getEndTime(k[e].time) : Math.max(this.timestamp0, this.timestamp));
                    var b = {
                        type: a,
                        chart: this.chart,
                        target: this,
                    ...
                    this.vZoomEnabled && 4 < Math.abs(this.mouseY0 - this.mouseY) && (b.startY = 1 - this.mouseY0 / this.height, b.endY = 1 - this.mouseY / this.height,
                        m = !0);
        ...
        dispatchPanEvent: function () {
            if (this.mouseIsDown) {
                var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3),
                    ...
                    e = d.roundTo((this.mouse2Y -
                        this.mouse2Y0) / this.height, 2),
                    h = !1;
        ...
        syncWithCursorReal: function (a, b) {
            ...
            var d = a.mouseX,
                f = a.mouseY;
            this.rotate ? (d = NaN, this.vvLine && this.vvLine.hide(), this.hhLine && e && (isNaN(a.fy) ?
                this.hhLine.translate(0, a.mouseY) : this.fixHLine(a.fy, 0))) : (f = NaN, this.hhLine && this.hhLine.hide(), this.vvLine && c && (isNaN(a.fx) ? this.vvLine.translate(a.mouseX, 0) : this.fixVLine(a.fx, 0)));
    ...
    d.SimpleChartScrollbar = d.Class({
            ...
            if (k) {
                ...
                if (n.mouseIsOver) {
                    ...
                    if (this.resizingRight) {
                        if (m)
                            if (a = r - e, a + e > p + f && (a = p - e + f), 0 > a) this.resizingRight = !1, b = this.resizingLeft = !0;
                            else {
                                if (0 === a || isNaN(a)) a = .1;
                                g.setAttr("height", a)
                            }
                        else if (a = t - c, a + c > q + d && (a = q - c + d), 0 > a) this.resizingRight = !1, b = this.resizingLeft = !0;
                        else {
                            if (0 === a || isNaN(a)) a = .1;
                            g.setAttr("width", a)
                        }
                    ...
                    if (this.resizingLeft) {
                        if (m)
                            if (c = e, e = r, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, 0 > a) this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f);
                            else {
                                if (0 === a || isNaN(a)) a = .1;
                                g.setAttr("y", e - f);
                                g.setAttr("height", a)
                            }
                        else if (e = t, e < d && (e = d), isNaN(e) && (e =
                                d), e > q + d && (e = q + d), a = !0 === b ? c - e : l + c - e, 0 > a) this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("x", c + l - d);
                        else {
                            if (0 === a || isNaN(a)) a = .1;
                            g.setAttr("x", e - d);
                            g.setAttr("width", a)
        ...
        clipDragger: function (a) {
            ...
            if (b) {
                ...
                f && (this.clipAndUpdate(c,
                    e, d, b), a && (this.updateOnReleaseOnly || this.dispatchScrollbarEvent()))
            }
        },
        maskGraphs: function () { },
        ...
        updateDragIconPositions: function () {
            ...
            this.rotate ? (f = this.dragIconWidth, g = this.dragIconHeight, e.translate((k - g) / 2, c - f / 2), d.translate((k - g) / 2, c + a.height - f / 2)) : (f = this.dragIconHeight, g = this.dragIconWidth, e.translate(b - g / 2, (k - f) / 2),
                d.translate(b - g / 2 + a.width, (k - f) / 2))
        },
        ...
        dispatchScrollbarEvent: function () {
            if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this);
                ...
                if (l.parseDates && !l.equalSpacing) {
                    ...
                    var n = l.xToIndex(b),
                        q = l.xToIndex(b + c);
                    if (n != this.start || this.end != q) l.startOnAxis && (this.resizingRight && n == q && q++, this.resizingLeft && n == q && (0 < n ? n-- : q = 1)), this.start = n, this.end = this.dragging ? this.start + this.difference : q, f.start = this.start, f.end = this.end, l.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))),
                        this.fire(f)
                }
                this.percentStart = n;
                this.percentEnd = q;
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.drop ? (g = C / 1.6, l = 0, "V" == y && (y = "down"), "H" == y && (y = "left"), "down" == y && (D = a + 1, z = b - g - g / 3), "up" == y && (l = 180, D = a + 1, z = b + g + g / 3), "left" == y && (l = 270, D = a + g + g / 3 + 2, z = b), "right" == y && (l = 90, D = a - g - g / 3 + 2, z = b), k = z - H / 2 + 1, m = D - J / 2 - 1, q = d.drop(h, g, l, q, w, r, p, Z)) : 0 < u || 0 === x ? (0 < O && (a = d.rect(h, C, A, q, 0, r + 1,
                        Q, O, u), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, C, A, q, w, r, p, Z, u)) : (t = [], u = [], "H" != y ? (g = a - D, g > C - x && (g = C - x), g < x && (g = x), t = [0, g - x, a - D, g + x, C, C, 0, 0], u = S ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (y = b - z, y > A - x && (y = A - x), y < x && (y = x), u = [0, y - x, b - z, y + x, A, A, 0, 0], t = a < g + (l - g) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < O && (a = d.polygon(h, t, u, q, 0, r, Q, O), a.translate(1, 1), f.push(a)), q = d.polygon(h, t, u, q, w, r, p, Z));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
...
(function () {
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            ...
            l = a.path(" M" + D + "," + C + " L" + D + "," + (C + l) + " L" + J + "," + (u + l) + " L" + J + "," + u + " L" + D + "," + C + " Z", void 0, void 0,
                "1000,1000").attr(H);
            e.push(Q);
            e.push(l)
        }
        ...
        a.handDrawn && (k = d.line(a, [y, z], [A, B], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]),
            e.push(k));
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function () {
            ...
            "outside" == b ? (c = f.offsetWidth, h = f.offsetHeight,
                f.clientHeight && (c = f.clientWidth, h = f.clientHeight)) : (isNaN(c) || (f.style.width = c + "px"), f.className = "amChartsLegend " + a.classNamePrefix + "-legend-div");
            this.divWidth = c;
            ...
            this.titleWidth = 0;
            if (h = this.title) h = d.text(this.container, h, this.color,
                a.fontFamily, this.fontSize, "start", !0), d.setCN(a, h, "legend-title"), h.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = h.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        arrangeEntries: function () {
            ...
            for (A = 0; A < y.length; A++) {
                ...
                u = J.getBBox();
                var H;
                this.equalWidths ? H = z * (p +
                    n + this.markerLabelGap) : (H = B, B = B + u.width + f + n);
        ...
        createEntry: function (a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.useGraphSettings) {
                    e = a.type;
                    b.switchType = void 0;
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) k = m.set(), a.hidden || (h = a.lineColorR, g = a.bulletBorderColorR), q = d.line(m, [0, 2 * n], [n / 2, n / 2], h, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(c, q,
                        "graph-stroke"), k.push(q), a.bullet && (a.hidden || (h = a.bulletColorR), q = d.bullet(m, a.bullet, a.bulletSize, h, a.bulletAlpha, a.bulletBorderThickness, g, a.bulletBorderAlpha)) && (d.setCN(c, q, "graph-bullet"), q.translate(n + 1, n / 2), k.push(q)), t = 0, q = n, p = n / 3;
                    else {
                        var r;
                ...
                g = b.switchType;
                var x;
                g && "none" != g && 0 < n && ("x" == g ? (x = b.createX(), x.translate(n / 2, n / 2)) : x = b.createV(), x.dItem = a, !0 !== a.hidden ?
                    "x" == g ? x.hide() : x.show() : "x" != g && x.hide(), b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch = x, m.push(x), d.setCN(c, x, "legend-switch"));
                g = b.color;
                ...
                c.accessible &&
                    b.accessibleLabel && (r = d.massReplace(b.accessibleLabel, {
                        "[[title]]": a.title
                ...
                var y;
                h && (h = d.fixBrakes(h), a.legendTextReal = h, y = b.labelWidth, y = isNaN(y) ? d.text(b.container, h, g, c.fontFamily, r, "start") : d.wrappedText(b.container, h, g, c.fontFamily, r, "start", !1, y, 0), d.setCN(c, y, "legend-label"), y.translate(b.lx + q, b.ly), m.push(y), c = y.getBBox().width, b.maxLabelWidth <
                    c && (b.maxLabelWidth = c));
                b.entries[b.index] = m;
        ...
        createValue: function (a) {
            ...
            if (!1 !== a.visibleInLegend &&
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    g = d.text(b.container, k, g, b.chart.fontFamily, c,
                        l);
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) f.value ? h.text(f.value) : h.text("");
                        ...
                        if (void 0 !== f.type) {
                            ...
                            k ? (g = this.valueText, f.legendValueText && (g = f.legendValueText), g = b.formatString(g, k)) : l && b.formatPeriodString &&
                                (l = d.massReplace(l, {
                                    "[[title]]": f.title
