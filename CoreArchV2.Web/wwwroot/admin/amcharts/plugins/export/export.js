...
if ( !AmCharts.translations[ "export" ][ "en" ] ) {
	AmCharts.translations[ "export" ][ "en" ] = {
		"fallback.save.text": "CTRL + C panoya verileri kopyalamak için.",
		"fallback.save.image": "Sağ Click -> Resmi Farklı Kaydet... Resmi kaydedebilirsiniz..",

		"capturing.delayed.menu.label": "{{duration}}",
		"capturing.delayed.menu.title": "İptal Etmek İçin Tıklayın",

		"menu.label.print": "Yazdır",
		"menu.label.undo": "Geri(Ctrl+Z)",
		"menu.label.redo": "İleri(Ctrl+Y)",
		"menu.label.cancel": "Vazgeç",

		"menu.label.save.image": "İndir ...",
		"menu.label.save.data": "Farklı Kaydet ...",

		"menu.label.draw": "Düzenle ...",
		"menu.label.draw.change": "Değiştir ...",
		"menu.label.draw.add": "Ekle ...",
		"menu.label.draw.shapes": "Icon ...",
		"menu.label.draw.colors": "Renk ...",
		"menu.label.draw.widths": "Genişlik ...",
